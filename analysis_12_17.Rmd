...
print(plot)
#ggsave("./graphs/plot.png", plot=plot, width = 8, height = 8, units = "cm")
...
library(ggpubr) # package for graphs
...
plot_model(I, type = "pred", terms = c("year", "ANC_T"), show.p = TRUE) + 
  geom_line()  +
  labs(y= "coverage rate BD", x = "year") +
  labs(title = "ANC times * year") +
  labs(colour =  "") +
...
figure <- ggarrange(A, B, C, ncol = 3, nrow = 1, labels = c("A", "B", "C"),
                    font.label = list(size = 12, color = "black", face = "plain", family = NULL))
figure


# text size etc can be changed!

#ggsave(filename = "./graphs/figure_ex.png", plot = figure, width = 30, height = 25, units = "cm", dpi = 300)

#ggsave(filename = "./graphs/figure_ex_2.png", plot = figure, width = 30, height = 15, units = "cm", dpi = 300)
# second options is better
# just examples on how the dimensions of the graphs change...
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta1_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP1.png", width = 8, height = 8, units = "cm")
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta12_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP2.png", width = 8, height = 8, units = "cm")
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta123_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP3.png", width = 8, height = 8, units = "cm")
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta1_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP4.png", width = 8, height = 8, units = "cm")
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta12_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP5.png", width = 8, height = 8, units = "cm")
...
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = penta123_RC)) +
  ...
  scale_y_continuous(labels=percent)
print(plot)
#ggsave("./graphs/plotP6.png", width = 8, height = 8, units = "cm")
```
