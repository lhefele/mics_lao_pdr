...
plot_model(F, type = "pred", terms = c("year", "PoB"))
plot_model(G, type = "pred", terms = c("year", "ANC"))
plot_model(H, type = "pred", terms = c("year", "ANC_W"))
plot_model(I, type = "pred", terms = c("year", "ANC_T"))
