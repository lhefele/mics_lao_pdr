...
svytable(~year + hepb0_RC_2 + hepb0_RC_24, design = mics_design_4_6_b1) -> tab
tab <- as.data.frame(tab)
ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = hepb0_RC_24)) +
  geom_col(position = "fill") 

png("plot.png")
plot <- ggplot(data = tab, mapping = aes(x=year, y=Freq, fill = hepb0_RC_2)) +
  geom_col(position = "fill") 
print(plot)
dev.off()
...
svytable(~hepb0_RC_2 + year, design = mics_design_4_6_b1) -> tab
tab <- as.data.frame(tab)
ggplot(data = tab, mapping = aes(x=year, y=hepb0_RC_2))
```
