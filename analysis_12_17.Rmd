...
summ(svyglm(hepb0_RC_2 ~MN18_1, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN1, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN2A, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN3_1, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
...
summ(svyglm(hepb0_RC_24 ~MN18_1, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_24 ~MN1, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_24 ~MN2A, design = mics_design_4_6_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
