...
# Odds ratios
# ordered logistic regression does work, but svy ratio function does not work because it needs numeric arguments? strange. 
svyolr(HH6~ethnicity, design=mics_design_b1)


svyratio(~windex5, denominator = ~HH6, design = mics_design_b1)
