...
mics4.ch_b1 %>% mutate(ethnicity_r = recode(ethnicity, "9" = 4)) -> mics4.ch_b1
mics4.ch_b1 %>% count(ethnicity_r, ethnicity)

mics4.ch_b1 %>% mutate(melevel_r = recode(melevel, "4" = 3, "5" = 3, "6" = 3, "9" = 1)) -> mics4.ch_b1
...
# change names
mics4.ch_p1$penta1_RC <- mics4.ch_p1$penta1_RC_1
mics4.ch_p1$penta1_R <- mics4.ch_p1$penta1_R_1
mics4.ch_p1$penta1_C <- mics4.ch_p1$penta1_C_1
...
mics4.ch_p1 %>% mutate(penta12_C = if_else(penta1_C_1 == 1 & penta2_C_1 == 1, 1, 0)) -> mics4.ch_p1
mics4.ch_p1 %>% count(penta12_C)

# new variable penta12 got at least two vaccinations according to card or recall
mics4.ch_p1 %>% mutate(penta12_RC = if_else(penta1_RC_1 == 1 & penta2_RC_1 == 1, 1, 0)) -> mics4.ch_p1
...
mics4.ch_p1 %>% count(penta1_C_1, penta2_C_1, penta3_C_1)
...
mics4.ch_p1 %>% mutate(ethnicity_r = recode(ethnicity, "9" = 4)) -> mics4.ch_p1
mics4.ch_p1 %>% count(ethnicity_r, ethnicity)

mics4.ch_p1 %>% mutate(melevel_r = recode(melevel, "4" = 3, "5" = 3, "6" = 3, "9" = 1)) -> mics4.ch_p1
...
A <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN18_1 + MN1 + MN2A, design = mics_design_p1, family = quasibinomial())
