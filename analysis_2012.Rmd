...
mics4.ch_var <- subset(mics4.ch, select = c("HH1", "HH2", "UF6", "UF8Y", "HH6", "HH7", "CAGE", "AG2", "CAGED", "IM1", "IM3H0D", "IM3H0M", "IM3H0Y", "IM3H1D", "IM3H1M", "IM3H1Y", "IM3H2D", "IM3H2M", "IM3H2Y", "IM3H3D", "IM3H3M", "IM3H3Y", "IM11", "IM12", "IM13", "IM14", "IM15", "AG1D", "AG1M", "AG1Y", "ethnicity", "melevel", "HH7R", "windex5", "HL4"))
...
mics4.ch_wm %>% replace_with_na(replace = list(MN18_1 = "9")) -> mics4.ch_wm
...
mics4.ch_wm %>% replace_with_na(replace = list(MN3_1 = "9")) -> mics4.ch_wm

mics4.ch_wm %>% count(MN3_1)

mics4.ch_wm %>% count(MN1)
mics4.ch_wm %>% replace_with_na(replace = list(MN1 = "9")) -> mics4.ch_wm
