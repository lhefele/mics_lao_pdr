...
mics4.ch_p1$penta1_C_1 <- as.factor(mics4.ch_p1$penta1_C_1)
mics4.ch_p1$penta2_C_1 <- as.factor(mics4.ch_p1$penta2_C_1)
mics4.ch_p1$penta3_C_1 <- as.factor(mics4.ch_p1$penta3_C_1)
mics4.ch_p1$penta1_R_1 <- as.factor(mics4.ch_p1$penta1_R_1)
mics4.ch_p1$penta2_R_1 <- as.factor(mics4.ch_p1$penta2_R_1)
mics4.ch_p1$penta3_R_1 <- as.factor(mics4.ch_p1$penta3_R_1)
...
svytable(~penta1_RC_1 + HH6, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = HH6)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + HH7R, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = HH7R)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + windex5, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = windex5)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + HL4, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = HL4)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + ethnicity, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = ethnicity)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + melevel, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = melevel)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 

# H0: penta1 coverage not associated with independent variables
# H1: penta1 coverage associated with independent variables
svychisq(~penta1_RC_1 + HH6, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + HH7R, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta1_RC_1 + windex5, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + HL4, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta1_RC_1 + ethnicity, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + melevel, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN3_1, design = mics_design_p1, statistic = "Chisq")



## penta2_RC_1

svytable(~penta2_RC_1 + HH6, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = HH6)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + HH7R, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = HH7R)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + windex5, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = windex5)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + HL4, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = HL4)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + ethnicity, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = ethnicity)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + melevel, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = melevel)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 

# H0: penta2 coverage not associated with independent variables
# H1: penta2 coverage associated with independent variables
svychisq(~penta2_RC_1 + HH6, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + HH7R, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta2_RC_1 + windex5, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + HL4, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta2_RC_1 + ethnicity, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + melevel, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN3_1, design = mics_design_p1, statistic = "Chisq")



## penta3_RC_1

svytable(~penta3_RC_1 + HH6, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = HH6)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + HH7R, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = HH7R)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + windex5, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = windex5)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + HL4, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = HL4)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + ethnicity, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = ethnicity)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + melevel, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = melevel)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 

# H0: penta3 coverage not associated with independent variables
# H1: penta3 coverage associated with independent variables
svychisq(~penta3_RC_1 + HH6, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + HH7R, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta3_RC_1 + windex5, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + HL4, design = mics_design_p1, statistic = "Chisq") #ns
svychisq(~penta3_RC_1 + ethnicity, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + melevel, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
summ(svyglm(penta123_RC ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(penta123_RC ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(penta123_RC ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(penta123_RC ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
