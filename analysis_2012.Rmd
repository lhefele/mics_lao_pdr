...
## I had the same problem as before... needed to change these variables into factors...

mics4.ch_b1$ethnicity <- as.factor(mics4.ch_b1$ethnicity)


mics4.ch_b1 %>% 
  dplyr::mutate(ethnicity_r = dplyr::recode(ethnicity, "1" = 1, "2" = 2, "3" = 3, "4" = 4, "9" = 4)) -> mics4.ch_b1

mics4.ch_b1 %>% count(ethnicity_r, ethnicity)
...
mics4.ch_b1 %>% replace_with_na(replace = list(MN18_1 = "9")) -> mics4.ch_b1

# Here is the conversion to NAs
...
mics4.ch_b1 %>% replace_with_na(replace = list(MN3_1 = "9")) -> mics4.ch_b1

mics4.ch_b1 %>% count(MN3_1)
