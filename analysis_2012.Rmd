...
```{r anc}
class(mics4.ch_wm$MN18)
mics4.ch_wm$MN18 <- as.factor(mics4.ch_wm$MN18)

# new variable place of delivery
mics4.ch_wm %>% mutate(MN18_1 = dplyr::recode(MN18,
                        "11" = "1",
                        "12" = "1",
                        "21" = "2",
                        "22" = "2",
                        ...
                        "98" = "3",
                        "99" = "9")) -> mics4.ch_wm
mics4.ch_wm %>% count(MN18_1)


mics4.ch_wm %>% mutate(MN3_1 = if_else(MN3 >= 1 & MN3 <=3, 1,
                                        if_else(MN3 >= 4 & MN3 <= 6, 2,
                                        if_else(MN3 == 98|  MN3 == 99 , 9, 3)))) -> mics4.ch_wm
mics4.ch_wm %>% count(MN3, MN3_1)

mics4.ch_wm %>% count(MN1)
...
mics4.ch_b1 %>% mutate(melevel_r = recode(melevel, "1" = 0, "2" = 1, "3" = 2, "4" = 2, "5" = 2, "6" = 2, "9" = 0)) -> mics4.ch_b1
...
tab <- svytable(~MN18_1, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
tab <- svytable(~MN1, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
tab <- svytable(~MN3_1, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
tab <- svytable(~MN2A, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
tab <- svytable(~MN2B, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
tab <- svytable(~MN2C, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
tab <- svytable(~MN2F, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
tab <- svytable(~MN2G, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
tab <- svytable(~MN2X, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
svytable(~hepb0_RC_2 + MN18_1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_2, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_2 + MN1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_2, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_2 + MN2A, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_2, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_2 + MN3_1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_2, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svytable(~hepb0_RC_24 + MN18_1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_24, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_24 + MN1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_24, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_24 + MN2A, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_24, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~hepb0_RC_24 + MN3_1, design = mics_design_b1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=hepb0_RC_24, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~hepb0_RC_2 + MN18_1, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_2 + MN1, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_2 + MN2A, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_2 + MN3_1, design = mics_design_b1, statistic = "Chisq")
...
svychisq(~hepb0_RC_24 + MN18_1, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_24 + MN1, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_24 + MN2A, design = mics_design_b1, statistic = "Chisq") 
svychisq(~hepb0_RC_24 + MN3_1, design = mics_design_b1, statistic = "Chisq")
...
summ(svyglm(hepb0_RC_2 ~MN18_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN2A, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_2 ~MN3_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
...
summ(svyglm(hepb0_RC_24 ~MN18_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_24 ~MN1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_24 ~MN2A, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
summ(svyglm(hepb0_RC_24 ~MN3_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 4)
...
full <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A + MN18_1, design = mics_design_b1, family = quasibinomial())
...
BPM <- svyglm(formula = hepb0_RC_2 ~ HH6 + windex5 + ethnicity_r + 
    melevel_r + MN1, design = mics_design_b1, family = quasibinomial())
...
A <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

B <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN3_1, design = mics_design_b1, family = quasibinomial())

C <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A, design = mics_design_b1, family = quasibinomial())

D <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN18_1, design = mics_design_b1, family = quasibinomial())

E <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + melevel_r + MN2A, design = mics_design_b1, family = quasibinomial())
...
A <- svyglm(hepb0_RC_2 ~HH6 + windex5 + ethnicity_r + MN1, design = mics_design_b1, family = quasibinomial())

B <- svyglm(hepb0_RC_2 ~HH6 + windex5 + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

C <- svyglm(hepb0_RC_2 ~HH6 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

D <- svyglm(hepb0_RC_2 ~ windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())
...
full <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A + MN18_1, design = mics_design_b1, family = quasibinomial())
...
A <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

B <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN3_1, design = mics_design_b1, family = quasibinomial())

C <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A, design = mics_design_b1, family = quasibinomial())

D <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN18_1, design = mics_design_b1, family = quasibinomial())

E <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + melevel_r + MN2A, design = mics_design_b1, family = quasibinomial())
...
A <- svyglm(hepb0_RC_24 ~HH6 + windex5 + ethnicity_r + MN1, design = mics_design_b1, family = quasibinomial())

B <- svyglm(hepb0_RC_24 ~HH6 + windex5 + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

C <- svyglm(hepb0_RC_24 ~HH6 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())

D <- svyglm(hepb0_RC_24 ~ windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_b1, family = quasibinomial())
...
mics4.ch_p1 %>% mutate(ethnicity_r = recode(ethnicity, "1" = 1, "2" = 2, "3" = 3, "4" = 4, "9" = 4)) -> mics4.ch_p1
mics4.ch_p1 %>% count(ethnicity_r)

mics4.ch_p1 %>% mutate(melevel_r = recode(melevel, "1" = 0, "2" = 1, "3" = 2, "4" = 2, "5" = 2, "6" = 2, "9" = 0)) -> mics4.ch_p1
mics4.ch_p1 %>% count(melevel, melevel_r)

# replace with NA "9" in antenatal care

class(mics4.ch_p1$MN18)
mics4.ch_p1$MN18 <- as.factor(mics4.ch_p1$MN18)

# new variable place of delivery
mics4.ch_p1 %>% mutate(MN18_1 = dplyr::recode(MN18,
                        "11" = "1",
                        "12" = "1",
                        "21" = "2",
                        "22" = "2",
                        ...
                        "98" = "3",
                        "99" = "3")) -> mics4.ch_p1
mics4.ch_p1 %>% count(MN18_1)


mics4.ch_p1 %>% mutate(MN3_1 = if_else(MN3 >= 1 & MN3 <=3, 1,
                                        if_else(MN3 >= 4 & MN3 <= 6, 2,
                                        if_else(MN3 == 98|  MN3 == 99 , 9, 3)))) -> mics4.ch_p1
mics4.ch_p1 %>% count(MN3_1)
...
mics4.ch_p1$MN18_1 <- as.factor(mics4.ch_p1$MN18_1)
mics4.ch_p1$MN1 <- as.factor(mics4.ch_p1$MN1)
mics4.ch_p1$MN2A <- as.factor(mics4.ch_p1$MN2A)
mics4.ch_p1$MN3_1 <- as.factor(mics4.ch_p1$MN3_1)
...
# place of delivery: MN18
mics4.ch_p1 %>% count(MN18_1)
tab <- svytable(~MN18_1, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
# received antenatal care: MN1
tab <- svytable(~MN1, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
# times received antenatal care: MN3
tab <- svytable(~MN3_1, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
tab <- svytable(~MN2A, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab
...
svytable(~penta1_RC + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta1_RC + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta1_RC + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta1_RC + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta1_RC + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta12_RC + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_RC, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta12_RC + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_RC, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta12_RC + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_RC, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta12_RC + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_RC, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta12_RC + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_RC + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_RC + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_RC + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta123_RC + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_RC, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta123_RC + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_RC, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta123_RC + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_RC, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta123_RC + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_RC, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta123_RC + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_RC + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_RC + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_RC + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta1_C + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_C, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta1_C + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_C, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta1_C + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_C, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta1_C + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_C, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta1_C + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_C + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_C + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_C + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta12_C + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_C, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta12_C + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_C, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta12_C + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_C, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta12_C + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_C, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta12_C + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_C + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_C + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_C + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta123_C + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_C, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta123_C + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_C, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta123_C + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_C, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta123_C + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_C, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta123_C + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_C + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_C + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_C + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta1_R + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_R, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta1_R + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_R, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta1_R + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_R, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta1_R + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_R, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta1_R + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_R + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_R + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_R + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta12_R + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_R, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta12_R + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_R, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta12_R + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_R, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta12_R + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta12_R, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta12_R + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_R + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_R + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta12_R + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta123_R + MN18_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_R, y=Freq, fill = MN18_1)) +
  geom_col(position = "fill") 

svytable(~penta123_R + MN1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_R, y=Freq, fill = MN1)) +
  geom_col(position = "fill") 

svytable(~penta123_R + MN2A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_R, y=Freq, fill = MN2A)) +
  geom_col(position = "fill") 

svytable(~penta123_R + MN3_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta123_R, y=Freq, fill = MN3_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta123_R + MN18_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_R + MN1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_R + MN2A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta123_R + MN3_1, design = mics_design_p1, statistic = "Chisq")
...
summ(svyglm(penta1_RC ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_RC ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_RC ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_RC ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta12_RC ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_RC ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_RC ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_RC ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta123_RC ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_RC ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_RC ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_RC ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta1_C ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_C ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_C ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_C ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta12_C ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_C ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_C ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_C ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta123_C ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_C ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_C ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_C ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta1_R ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_R ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_R ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta1_R ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta12_R ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_R ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_R ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta12_R ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
summ(svyglm(penta123_R ~MN18_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_R ~MN1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_R ~MN2A, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
summ(svyglm(penta123_R ~MN3_1, design = mics_design_p1, family = quasibinomial()), exp = TRUE, confint = TRUE, digits = 2)
...
BPM <- svyglm(formula = penta123_RC ~ HH6 + windex5 + ethnicity_r + 
    melevel_r + MN1, design = mics_design_p1, family = quasibinomial())
...
A <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_p1, family = quasibinomial())

B <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN3_1, design = mics_design_p1, family = quasibinomial())

C <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A, design = mics_design_p1, family = quasibinomial())

D <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN18_1, design = mics_design_p1, family = quasibinomial())

E <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN2A, design = mics_design_p1, family = quasibinomial())
...
A <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + MN1, design = mics_design_p1, family = quasibinomial())

B <- svyglm(penta123_RC ~HH6 + windex5 + melevel_r + MN1, design = mics_design_p1, family = quasibinomial())

C <- svyglm(penta123_RC ~HH6 + ethnicity_r + melevel_r + MN1, design = mics_design_p1, family = quasibinomial())

D <- svyglm(penta123_RC ~ windex5 + ethnicity_r + melevel_r + MN1, design = mics_design_p1, family = quasibinomial())
...
A <- svyglm(penta123_RC ~HH6 + windex5 + ethnicity_r + melevel_r + MN1 + MN2A, design = mics_design_p1, family = quasibinomial())
