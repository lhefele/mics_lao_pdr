...
mics6.wm_var <- subset(mics6.wm, select = c("HH1", "HH2", "LN", "MN2", "MN3A", "MN3B", "MN3C", "MN3F", "MN3G", "MN3X", "MN5", "MN20"))
...
tab_MN1 <- svytable(~MN1, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN1 
...
tab_MN3 <- svytable(~MN3, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3 
...
mics6.ch_b1 %>% count(MN2A, MN2B, MN2C,MN2F, MN2G, MN2X)

tab_MN2A <- svytable(~MN2A, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2A 
tab_MN2B <- svytable(~MN2B, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2B
tab_MN2C <- svytable(~MN2C, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2C
tab_MN2F <- svytable(~MN2F, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2F
tab_MN2G <- svytable(~MN2G, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2G
tab_MN2X <- svytable(~MN2X, design = mics_design) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2X
