...
mics6.ch_wm %>% mutate(ethnicity_r = recode(ethnicity, "9" = 4)) -> mics6.ch_wm
mics6.ch_wm %>% count(ethnicity_r, ethnicity)

mics6.ch_wm %>% mutate(melevel_r = recode(melevel, "3" = 2, "4" = 2, "5" = 2, "9" = 0)) -> mics6.ch_wm
mics6.ch_wm %>% count(melevel, melevel_r)
```
...
mics6.ch_p1 %>% count(MN5_1)
mics6.ch_b1 %>% count(MN5_1)
