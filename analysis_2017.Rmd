...
tab_MN20 <- svytable(~MN20_1, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN20 
...
tab_MN2 <- svytable(~MN2, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2
...
tab_MN5 <- svytable(~MN5_1, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN5 
...
tab_MN3A <- svytable(~MN3A, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3A 
tab_MN3B <- svytable(~MN3B, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3B
tab_MN3C <- svytable(~MN3C, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3C
tab_MN3F <- svytable(~MN3F, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3F
tab_MN3G <- svytable(~MN3G, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3G
tab_MN3X <- svytable(~MN3X, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3X
tab_MN3NR <- svytable(~MN3NR, design = mics_design_b1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3NR
...
mics6.ch_p1$penta1_RC_1 <- as.factor(mics6.ch_p1$penta1_RC_1)
mics6.ch_p1$penta2_RC_1 <- as.factor(mics6.ch_p1$penta2_RC_1)
mics6.ch_p1$penta3_RC_1 <- as.factor(mics6.ch_p1$penta3_RC_1)
mics6.ch_p1$penta1_C_1 <- as.factor(mics6.ch_p1$penta1_C_1)
mics6.ch_p1$penta2_C_1 <- as.factor(mics6.ch_p1$penta2_C_1)
mics6.ch_p1$penta3_C_1 <- as.factor(mics6.ch_p1$penta3_C_1)
mics6.ch_p1$penta1_R_1 <- as.factor(mics6.ch_p1$penta1_R_1)
mics6.ch_p1$penta2_R_1 <- as.factor(mics6.ch_p1$penta2_R_1)
mics6.ch_p1$penta3_R_1 <- as.factor(mics6.ch_p1$penta3_R_1)
```
...
tab_ethnicity <- svytable(~ethnicity, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_ethnicity
...
tab_windex5 <- svytable(~windex5, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_windex5 
...
tab_hh7r <- svytable(~hh7r, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_hh7r 
...
tab_MN20 <- svytable(~MN20_1, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN20 
...
# received antenatal care: MN2
tab_MN2 <- svytable(~MN2, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN2
...
# times received antenatal care: MN5
tab_MN5 <- svytable(~MN5_1, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN5 
...
tab_MN3A <- svytable(~MN3A, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3A 
tab_MN3B <- svytable(~MN3B, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3B
tab_MN3C <- svytable(~MN3C, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3C
tab_MN3F <- svytable(~MN3F, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3F
tab_MN3G <- svytable(~MN3G, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3G
tab_MN3X <- svytable(~MN3X, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3X
tab_MN3NR <- svytable(~MN3NR, design = mics_design_p1) %>% 
  as.data.frame() %>% 
  mutate(Prop = round(Freq / sum(Freq)*100, 2)) %>%
  mutate(Total = sum(Freq)) 
tab_MN3NR
