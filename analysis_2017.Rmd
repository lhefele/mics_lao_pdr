...
summ(svyglm(hepb0_RC_2 ~HH6, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~hh7r, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~windex5, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~HL4, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~ethnicity, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~melevel, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~MN20_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~MN2, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~MN3A, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
summ(svyglm(hepb0_RC_2 ~MN5_1, design = mics_design_b1, family = quasibinomial()), exp = TRUE, confint = TRUE)
...
mics6.ch_p1 %>% count(penta1_R_1_n, penta2_R_1_n, penta3_R_1_n)
mics6.ch_p1 %>% count(penta1_R_1_f, penta2_R_1_f, penta3_R_1_f)
...
mics6.ch_p1 %>% count(penta1_RC_1_f, penta2_RC_1_f, penta3_RC_1_f)
