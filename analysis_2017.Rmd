...
mics6.ch_wm <- merge(mics6.ch, mics6.wm_var, by=c("HH1", "HH2", "UF4"), all.x = TRUE)
...
# data b1
mics6.ch_b1$hh7r_n <- as.numeric(mics6.ch_b1$hh7r)
mics6.ch_b1$HH6_n <- as.numeric(mics6.ch_b1$HH6)
mics6.ch_b1$windex5_n <- as.numeric(mics6.ch_b1$windex5)
mics6.ch_b1$HL4_n <- as.numeric(mics6.ch_b1$HL4)
mics6.ch_b1$ethnicity_n <- as.numeric(mics6.ch_b1$ethnicity)
mics6.ch_b1$melevel_n <- as.numeric(mics6.ch_b1$melevel)
mics6.ch_b1$MN20_1_n <- as.numeric(mics6.ch_b1$MN20_1)
mics6.ch_b1$MN2_n <- as.numeric(mics6.ch_b1$MN2)
mics6.ch_b1$MN3A_n <- as.numeric(mics6.ch_b1$MN3A)
mics6.ch_b1$MN5_1_n <- as.numeric(mics6.ch_b1$MN5_1)

mics6.ch_b1$hepb0_RC_2_n <- as.numeric(mics6.ch_b1$hepb0_RC_2)
mics6.ch_b1$hepb0_RC_24_n <- as.numeric(mics6.ch_b1$hepb0_RC_24)
mics6.ch_b1$hepb0_C_2_n <- as.numeric(mics6.ch_b1$hepb0_C_2)
mics6.ch_b1$hepb0_C_24_n <- as.numeric(mics6.ch_b1$hepb0_C_24)
mics6.ch_b1$hepb0_R_2_n <- as.numeric(mics6.ch_b1$hepb0_R_2)
mics6.ch_b1$hepb0_R_24_n <- as.numeric(mics6.ch_b1$hepb0_R_24)

# data b1
mics6.ch_b1$hh7r_f <- as.factor(mics6.ch_b1$hh7r)
mics6.ch_b1$HH6_f <- as.factor(mics6.ch_b1$HH6)
mics6.ch_b1$windex5_f <- as.factor(mics6.ch_b1$windex5)
mics6.ch_b1$HL4_f <- as.factor(mics6.ch_b1$HL4)
mics6.ch_b1$ethnicity_f <- as.factor(mics6.ch_b1$ethnicity)
mics6.ch_b1$melevel_f <- as.factor(mics6.ch_b1$melevel)
mics6.ch_b1$MN20_1_f <- as.factor(mics6.ch_b1$MN20_1)
mics6.ch_b1$MN2_f <- as.factor(mics6.ch_b1$MN2)
mics6.ch_b1$MN3A_f <- as.factor(mics6.ch_b1$MN3A)
mics6.ch_b1$MN5_1_f <- as.factor(mics6.ch_b1$MN5_1)

mics6.ch_b1$hepb0_RC_2_f <- as.factor(mics6.ch_b1$hepb0_RC_2)
mics6.ch_b1$hepb0_RC_24_f <- as.factor(mics6.ch_b1$hepb0_RC_24)
mics6.ch_b1$hepb0_C_2_f <- as.factor(mics6.ch_b1$hepb0_C_2)
mics6.ch_b1$hepb0_C_24_f <- as.factor(mics6.ch_b1$hepb0_C_24)
mics6.ch_b1$hepb0_R_2_f <- as.factor(mics6.ch_b1$hepb0_R_2)
mics6.ch_b1$hepb0_R_24_f <- as.factor(mics6.ch_b1$hepb0_R_24)
```
...
mics6.ch_b1 %>% count(CAGE_6) # Age groups
mics6.ch_b1 %>% count(CAGE_11) # other age grouping
...
#svyratio(~HH6, denominator = ~ethnicity, design=mics_design_b1) # does not work


#mics_design_b2 <- svydesign(data = mics6.ch_b1, weights = ~chweight, id = ~strata+HH1)
#mics_design_b2


#svyratio(~HH6, denominator = ~ethnicity, design=mics_design_b2) # does not work
...
mics6.ch_p1 %>% count(penta1_RC_1) # 0: 1340 1: 3200
mics6.ch_p1 %>% count(penta1_R_1) # 0: 1051 1: 1376
mics6.ch_p1 %>% count(penta1_C_1) # 0: 289 1: 1824
...
# data p1
mics6.ch_p1$hh7r_n <- as.numeric(mics6.ch_p1$hh7r)
mics6.ch_p1$HH6_n <- as.numeric(mics6.ch_p1$HH6)
mics6.ch_p1$windex5_n <- as.numeric(mics6.ch_p1$windex5)
mics6.ch_p1$HL4_n <- as.numeric(mics6.ch_p1$HL4)
mics6.ch_p1$ethnicity_n <- as.numeric(mics6.ch_p1$ethnicity)
mics6.ch_p1$melevel_n <- as.numeric(mics6.ch_p1$melevel)

mics6.ch_p1$penta1_RC_1_n <- as.numeric(mics6.ch_p1$penta1_RC_1)
mics6.ch_p1$penta2_RC_1_n <- as.numeric(mics6.ch_p1$penta2_RC_1)
mics6.ch_p1$penta3_RC_1_n <- as.numeric(mics6.ch_p1$penta3_RC_1)
mics6.ch_p1$penta1_C_1_n <- as.numeric(mics6.ch_p1$penta1_C_1)
mics6.ch_p1$penta2_C_1_n <- as.numeric(mics6.ch_p1$penta2_C_1)
mics6.ch_p1$penta3_C_1_n <- as.numeric(mics6.ch_p1$penta3_C_1)
mics6.ch_p1$penta1_R_1_n <- as.numeric(mics6.ch_p1$penta1_R_1)
mics6.ch_p1$penta2_R_1_n <- as.numeric(mics6.ch_p1$penta2_R_1)
mics6.ch_p1$penta3_R_1_n <- as.numeric(mics6.ch_p1$penta3_R_1)

# data p1
mics6.ch_p1$hh7r_f <- as.factor(mics6.ch_p1$hh7r)
mics6.ch_p1$HH6_f <- as.factor(mics6.ch_p1$HH6)
mics6.ch_p1$windex5_f <- as.factor(mics6.ch_p1$windex5)
mics6.ch_p1$HL4_f <- as.factor(mics6.ch_p1$HL4)
mics6.ch_p1$ethnicity_f <- as.factor(mics6.ch_p1$ethnicity)
mics6.ch_p1$melevel_f <- as.factor(mics6.ch_p1$melevel)

mics6.ch_p1$penta1_RC_1_f <- as.factor(mics6.ch_p1$penta1_RC_1)
mics6.ch_p1$penta2_RC_1_f <- as.factor(mics6.ch_p1$penta2_RC_1)
mics6.ch_p1$penta3_RC_1_f <- as.factor(mics6.ch_p1$penta3_RC_1)
mics6.ch_p1$penta1_C_1_f <- as.factor(mics6.ch_p1$penta1_C_1)
mics6.ch_p1$penta2_C_1_f <- as.factor(mics6.ch_p1$penta2_C_1)
mics6.ch_p1$penta3_C_1_f <- as.factor(mics6.ch_p1$penta3_C_1)
mics6.ch_p1$penta1_R_1_f <- as.factor(mics6.ch_p1$penta1_R_1)
mics6.ch_p1$penta2_R_1_f <- as.factor(mics6.ch_p1$penta2_R_1)
mics6.ch_p1$penta3_R_1_f <- as.factor(mics6.ch_p1$penta3_R_1)
```
...
svytable(~penta1_RC_1 + MN20_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN20_1)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN2, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN2)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN3A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN3A)) +
  geom_col(position = "fill") 

svytable(~penta1_RC_1 + MN5_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta1_RC_1, y=Freq, fill = MN5_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta1_RC_1 + MN20_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN2, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN3A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta1_RC_1 + MN5_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta2_RC_1 + MN20_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN20_1)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN2, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN2)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN3A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN3A)) +
  geom_col(position = "fill") 

svytable(~penta2_RC_1 + MN5_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta2_RC_1, y=Freq, fill = MN5_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta2_RC_1 + MN20_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN2, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN3A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta2_RC_1 + MN5_1, design = mics_design_p1, statistic = "Chisq")
...
svytable(~penta3_RC_1 + MN20_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN20_1)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN2, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN2)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN3A, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN3A)) +
  geom_col(position = "fill") 

svytable(~penta3_RC_1 + MN5_1, design = mics_design_p1) -> tab
tab <- as.data.frame(tab)
tab
ggplot(data = tab, mapping = aes(x=penta3_RC_1, y=Freq, fill = MN5_1)) +
  geom_col(position = "fill") 
...
svychisq(~penta3_RC_1 + MN20_1, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN2, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN3A, design = mics_design_p1, statistic = "Chisq") 
svychisq(~penta3_RC_1 + MN5_1, design = mics_design_p1, statistic = "Chisq")
...
model <- svyglm(hepb0_RC_2_n ~HH6_n, design = mics_design_b1)
summary(model)

summ(svyglm(hepb0_RC_2_n ~HH6_n, design = mics_design_b1, family = quasibinomial()), exp = TRUE)
svyratio(~hepb0_RC_2_n, ~HH6_n, design = mics_design_b1)
```
