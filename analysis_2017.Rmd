...
mics6.ch_2 %>% filter(UB2 < 3) %>% count(IM2, IM5)
# First, need to convert NAs in IM5

mics6.ch_2 %>% mutate(IM5_2 = replace(IM5, is.na(IM5) & UB2 < 3, 5)) -> mics6.ch_2
mics6.ch_2 %>% count(IM5, IM5_2, recall)


# Variable 2
# Info from any document 
mics6.ch_2 %>% mutate(IM5_3 = recode(IM5_2, "5" = 4)) -> mics6.ch_2
mics6.ch_2 %>% count(IM5_2, IM5_3) # ok

# recall variable IM11 in combination with IM5_2
mics6.ch_2 %>% filter(UB2 < 3) %>% count(IM5_2, IM11)
...
mics6.ch_2 %>% filter(UB2 < 3) -> mics6.ch_b1 
...
mics_design_2 <- svydesign(data = mics6.ch_p1, 
                         weights = ~chweight, 
                         id = ~strata+HH1)
mics_design_2
